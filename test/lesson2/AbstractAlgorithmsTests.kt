...
Но вреден север для меня
        ...
        assertEquals("ы", longestCommonSubstring("мы", "ты"))
        assertEquals(
            "высокомногорассмотрительствующий",
            longestCommonSubstring(
                "высокомногорассмотрительствующий",
                "ты довольно Превысокомногорассмотрительствующий"
            )
        )
    }
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(4479422, calcPrimesNumber(76543210))
